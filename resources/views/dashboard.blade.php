        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form class="max-w-sm mx-auto">
                ...
                <div class="mb-5">
                    ...
                    <select name="apartment" id="apartment" class="text-black  font-medium rounded-lg text-sm text-center inline-flex items-center">
                        <option value="1">A (A-01)</option>
                        <option value="2">B (B-01)</option>
                    </select>
                </div>
